...
import { Timeline } from "../components/CapsTimeline";
...
const AboutUs: React.FC = () => {
  ...
  const [departments, setDepartments] = React.useState<
    Partial<Record<number, Department>>
  >({});
  ...
  return (
    <div className="bg-[#FAFAFA] min-h-screen">
      ...
      <div className="pt-24 px-4 max-w-4xl mx-auto pb-20">
        <h1 className="text-3xl font-bold text-center">CAPS 소개</h1>
        <nav
          aria-label="소개 페이지 바로가기"
          className="flex justify-center gap-6 mt-4"
        >
          <a href="#executives" className="text-blue-600 hover:underline">
            집행부 소개
          </a>
        ...
        <section
          ...
          aria-labelledby="executives-title"
        >
          <h2
            id="executives-title"
          ...
          <div className="text-center mt-8">
            <div className="text-xs text-gray-400 mb-1">제 39.5대 집행부</div>
            <div className="text-lg font-bold mb-2">
              모두가 참여할 수 있는 활동을 추구하는 집행부를 소개합니다!
            </div>
          </div>
          {/* 회장/부회장 */}
          <div className="flex justify-center gap-8 sm:gap-16 mt-8">
          ...
          {/* 부서 탭 및 멤버 */}
          <div className="mt-12 bg-[#007AEB] bg-opacity-5 rounded-3xl p-4 md:p-10 overflow-hidden">
            <div className="mb-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-y-10 gap-x-4 justify-items-center">
              {!currentDepartment ? (
                <div className="col-span-2 md:col-span-3 text-gray-400 text-center py-8">
                  집행부 정보를 불러오는 중입니다...
                </div>
      ...
      <section
        ...
        className="scroll-mt-24 max-w-3xl mx-auto px-4 pb-12"
      >
        <h2 id="history-title" className="text-2xl font-bold text-center mb-6">
          연혁
        </h2>
        <Timeline />
      </section>
