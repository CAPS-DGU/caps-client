...
const historyData = [
  {
    year: "1988",
    events: ["1월 학술학회 C.A.P.S설립 (초대 회장 87학번 변태경)"],
  },
  {
    year: "1989",
    events: [
  ...
  {
    year: "1995",
    events: ["12월 9대 집행부 결성 (9대 회장 95학번 이희원)"],
  },
  {
    year: "1996",
    events: ["12월 10대 집행부 결성 (10대 회장 96학번 노상래)"],
  },
  {
    year: "1997",
    events: ["12월 11대 집행부 결성 (11대 회장 97학번 고영관)"],
  },
  {
    year: "1998",
    events: [
  ...
  {
    year: "2001",
    events: ["12월 15대 집행부 결성 (15대 회장 01학번 이지현)"],
  },
  {
    year: "2002",
    events: [
  ...
  {
    year: "2007",
    events: ["12월 21대 집행부 결성 (21대 회장 07학번 이지선)"],
  },
  {
    year: "2008",
    events: [
  ...
  {
    year: "2009",
    events: ["12월 23대 집행부 결성 (23대 회장 09학번 차윤제)"],
  },
  {
    year: "2010",
    events: ["12월 24대 집행부 결성 (24대 회장 10학번 안성훈)"],
  },
  {
    year: "2011",
    events: ["12월 25대 집행부 결성 (25대 회장 11학번 박선영)"],
  },
  {
    year: "2012",
    events: ["12월 26대 집행부 결성 (26대 회장 08학번 이호빈)"],
  },
  {
    year: "2013",
    events: ["12월 27대 집행부 결성 (27대 회장 13학번 왕인내)"],
  },
  {
    year: "2014",
    events: ["12월 28대 집행부 결성 (28대 회장 14학번 김창규)"],
  },
  {
    year: "2015",
    events: [
  ...
  {
    year: "2016",
    events: ["12월 30대 집행부 결성 (30대 회장 16학번 명지수)"],
  },
  {
    year: "2017",
    events: ["3월 제 15회 C.A.P.S 소프트웨어 전시회 개최"],
  },
  {
    year: "2018",
    events: [
  ...
  {
    year: "2019",
    events: ["1월 32대 집행부 결성(32대 회장 18학번 임연지)"],
  },
  {
    year: "2020",
    events: [
  ...
  {
    year: "2023",
    events: ["4월 37기 집행부 결성(36대 회장 21학번 박서영)"],
  },
  {
    year: "2024",
    events: [
        ...
        .map((item) => (
          <li key={item.year} className="flex items-start relative">
            ...
            <div>
              ...
              <ul className="ml-1">
                {[...item.events].reverse().map((event, i) => (
                  <li key={i} className="text-base text-gray-700 mb-1">
                    {event}
                  </li>
                ))}
              </ul>
