  ...
  return (
    <div className="mb-6">
      ...
      <p className="mb-2 text-gray-700">
        <strong>작성자:</strong> {maker.grade}기 {maker.name}
      </p>
      <p className="mb-2 text-gray-700">
        <strong>카테고리:</strong> {category}
      </p>
      <p className="mb-2 text-gray-700">
        <strong>학기:</strong> {year}년 {translateSemester(semester)}{" "}
      </p>
      <p className="mb-2 text-gray-700">
        <strong>요일:</strong> {translateDay(day)}
      </p>
      <p className="mb-2 text-gray-700">
      ...
      <p className="mb-2 text-gray-700">
        <strong>참여자 수:</strong> {participants.length}/{maxParticipants}
      </p>
