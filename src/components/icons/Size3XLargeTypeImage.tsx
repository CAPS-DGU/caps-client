...
export const Size3XLargeTypeImage = ({ className }: { className?: string }) => {
  return (
    <svg
      className={`${className}`}
      fill="none"
    ...
    >
      <path
        d="M0 28C0 12.544 12.544 0 28 0C43.456 0 56 12.544 56 28C56 43.456 43.456 56 28 56C12.544 56 0 43.456 0 28Z"
        fill="#B3B3B3"
      />
